...
//            using (var colorHelper = new ColorBalancer(BuildInColorShemes.Windows10Definitions().ToArray()).CustomizedDefault(
...
//            using (
//                var colorHelper = new CloseColorFinder(BuildInColorShemes.Windows10Definitions().ToArray()).CustomizedDefault(
